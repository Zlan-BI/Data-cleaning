...
sales_replaced = daily_sales.replace(";,;", ";")
sales_lst = sales_replaced.split(",")
# print(sales_lst)
daily_txn_split = []
for i in sales_lst:
    for j in i.split(";"):
        daily_txn_split.append(j)
# print(daily_txn_split)
transactions_clean = []
for i in daily_txn_split:
